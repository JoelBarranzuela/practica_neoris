...
import com.jbarranzuela.prueba.tecnica.users.dto.response.ErrorsResponse;
import com.jbarranzuela.prueba.tecnica.users.exception.IdNotFoundException;
...
public class BadRequestController {
    @ExceptionHandler({IdNotFoundException.class, UsernameNotFoundException.class, ResponseStatusException.class})
